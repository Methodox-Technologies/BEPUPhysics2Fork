                ...
                if (line.Contains("/*[META]"))
                {
                    while (true)
                    {
                        ...
                        if (line.StartsWith(defineString))
                        {
                            ...
                            string[] values = line.Substring(open + 1, close - open - 1).Split(',');
                        ...
                        {
                            //Vertex shader.
                            string entryPoint = line.Substring(2).Trim();
                            StageProperties stage = Stages[(int)ShaderType.VS];
                        ...
                        else if (line.StartsWith("gs"))
                        {
                            //Geometry shader.
                            string entryPoint = line.Substring(2).Trim();
                            StageProperties stage = Stages[(int)ShaderType.GS];
                        ...
                        else if (line.StartsWith("hs"))
                        {
                            //Hull shader.
                            string entryPoint = line.Substring(2).Trim();
                            StageProperties stage = Stages[(int)ShaderType.HS];
                        ...
                        else if (line.StartsWith("ds"))
                        {
                            //Domain shader.
                            string entryPoint = line.Substring(2).Trim();
                            StageProperties stage = Stages[(int)ShaderType.DS];
                        ...
                        else if (line.StartsWith("ps"))
                        {
                            //Pixel shader.
                            string entryPoint = line.Substring(2).Trim();
                            StageProperties stage = Stages[(int)ShaderType.PS];
                        ...
                        else if (line.StartsWith("cs"))
                        {
                            //Compute shader.
                            string entryPoint = line.Substring(2).Trim();
                            StageProperties stage = Stages[(int)ShaderType.CS];
