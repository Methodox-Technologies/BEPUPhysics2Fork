...
public class Colosseum24VideoDemo : DemoBase
{
    ...
    public override void Initialize(ContentArchive content, Camera camera)
    {
        ...
        BodyDescription boxDescription = BodyDescription.CreateDynamic(new Vector3(), ringBoxShape.ComputeInertia(1), new(Simulation.Shapes.Add(ringBoxShape), 0.1f), -0.01f);
        ...
        int heightPerPlatform = 10;
        int platformsPerLayer = 30;
